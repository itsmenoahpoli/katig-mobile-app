    ...
    <View className="flex-1 justify-between items-center pb-[50px] relative">
      ...
      <View className="h-full w-full flex flex-col justify-center items-center gap-y-5 px-10">
        ...
        <View className="flex flex-col mb-5">
          <Text className="text-[30px] text-center text-dark font-bold">Fast and safe</Text>
          <Text className="text-[30px] text-center text-dark font-bold">Onboarding</Text>
        </View>

        <Text className="text-lg text-center text-dark mb-5">Quick and secure onboarding to get you started right away!</Text>
